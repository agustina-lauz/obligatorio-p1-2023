...
class Datos:
        ...
        while True:
            try:
                ...
                if len(cedula) == 8 and cedula.isdigit():
                    ...
                    if len(cedula) != 8:
                        print (NoRespetaMetodoDefinido("La cedula debe tener 8 digitos"))
                    else:
                        raise ValueError
            except ValueError:
    ...
    def set_fecha_nacimiento():
        while True:
            try:
                fecha_nacimiento = input("Ingrese la fecha de nacimiento del empleado (dd/mm/aaaa): ")
                fecha_nacimiento = datetime.datetime.strptime(
                    fecha_nacimiento, '%d/%m/%Y')
                return fecha_nacimiento
            except:
                print(NoRespetaMetodoDefinido("la fecha no fue ingresada de manera correcta"))
        ...
        while True:
            try:
                ...
                if cargo in [0, 1, 2]:
                    ...
                    print( NoRespetaMetodoDefinido("El cargo ingresado no es valido ya que no existe"))
            except ValueError:
    ...
    def set_equipo():
        while True:
            try:
                ...
                print(TipovalorErroneo("El nombre del equipo no debe contener numeros"))
    ...
    def set_score():
        while True:
            try:
             ...
             print(TipovalorErroneo("El score debe ser un número entero y no puede contener letras"))
    ...
    def set_anio():
        while True:
            try:
               ...
               print( TipovalorErroneo("El año debe ser un número entero y no debe contener letras"))

    def set_titular():
        while True:  
            try:
                titular = int(input( "Ingrese 1 si el piloto es titular o 2 si es de reserva: "))
                if titular == 1:
                    return True
                elif titular == 2:
                    return False
                ...
                print( TipovalorErroneo("El valor del titular no debe contener letras"))
